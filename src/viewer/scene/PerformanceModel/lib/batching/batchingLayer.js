...
class BatchingLayer {
    ...
    constructor(model, cfg) {
        ...
        this.isTransformedAndEncoded = !!cfg.isTransformedAndEncoded;
        this.isQuantized = !!cfg.isQuantized;

        this.positionsDecodeMatrix = cfg.positionsDecodeMatrix;
    ...
    createPortion(positions, normals, indices, edgeIndices, flags, color, opacity, matrix, aabb, pickColor) {
        ...
        { // Positions
            if (this.isTransformedAndEncoded) {
    ...
    finalize() {
        ...
        if (this.isQuantized) {
            state.positionsDecodeMatrix = this.positionsDecodeMatrix;
...
export {BatchingLayer,transformAndOctEncodeNormals,quantizePositions};
